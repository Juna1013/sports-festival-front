...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1758378229112.8953";
}
function TournamentPage() {
  ...
  const renderMatch = (tournament) => {
    return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-white/90 backdrop-blur-sm border border-white/30 rounded-xl p-4 shadow-lg hover:shadow-xl hover:bg-white hover:-translate-y-1 transition-all duration-300 transform", children: [
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Layout, { title: `${event.name} - \u30C8\u30FC\u30CA\u30E1\u30F3\u30C8\u8868`, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mb-6", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/events", className: "inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg", children: "\u2190 \u7AF6\u6280\u30B9\u30B1\u30B8\u30E5\u30FC\u30EB\u306B\u623B\u308B" }, void 0, false, {
      fileName: "app/routes/tournaments.$eventId.tsx",
      lineNumber: 100,
      columnNumber: 9
    }, this) }, void 0, false, {
    ...
    tournaments.length === 0 ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-white/90 backdrop-blur-sm border border-white/30 rounded-xl p-6 text-center shadow-xl", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-gray-700 text-sm", children: "\u3053\u306E\u7AF6\u6280\u306E\u30C8\u30FC\u30CA\u30E1\u30F3\u30C8\u60C5\u5831\u306F\u3042\u308A\u307E\u305B\u3093\u3002" }, void 0, false, {
      fileName: "app/routes/tournaments.$eventId.tsx",
      lineNumber: 106,
      columnNumber: 11
    }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-white/90 backdrop-blur-sm border border-white/30 rounded-xl p-6 shadow-xl", children: [
